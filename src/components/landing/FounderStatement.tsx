  ...
  return (
    <section className="border-b border-ivory-200 bg-ivory">
      <div className="mx-auto max-w-8xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        <p className="flex items-center gap-3 text-[12px] font-semibold uppercase tracking-[0.24em] text-gold-600"><span className="gold-rule" aria-hidden="true" />Kurucumuzdan</p>
        <blockquote className="mt-8 max-w-[1000px] font-serif text-[22px] font-normal italic leading-[1.3] tracking-[-0.015em] text-navy min-[420px]:text-[24px] sm:text-[30px] lg:text-[36px]">
        ...
        <div className="mt-8 flex flex-col gap-6 sm:mt-12 sm:flex-row sm:items-end sm:justify-between sm:gap-8">
          <div className="border-l border-gold pl-4 text-[16px] leading-relaxed text-navy">
            <p className="font-semibold">Av. Furkan Tunca</p>
            <p className="text-[#5f6977]">Kurucu</p>
          </div>
