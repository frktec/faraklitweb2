...
export function FinalCTA() {
  return (
    <section className="border-t border-white/10 bg-navy py-20 text-white lg:py-24">
      <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-end gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:gap-20">
          <div>
            <p className="flex items-center gap-3 text-[12px] font-semibold uppercase tracking-[0.24em] text-gold"><span className="gold-rule" aria-hidden="true" />Faraklit</p>
          ...
          <div>
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link to="/pricing" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-[4px] bg-ivory px-7 text-[15px] font-semibold text-navy transition-colors hover:bg-white">
